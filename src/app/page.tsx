...
export default function HomePage() {
  return (
    <main className="h-screen w-full flex-col justify-between">
      <NavBar />
        ...
        <div className="w-[90%] m-auto mt-[4%] p-5 flex flex-col sm:flex-row justify-evenly items-center">
          ...
          <div className="max-w-[70%] justify-start space-y-4 mt-[6%] sm:mt-3">
            ...
            <p>
              ...
              esse, animi exercitationem officiis odio quidem consequuntur
              debitis atque eligendi quia harum veritatis quis ex laborum
              maiores nostrum, qui obcaecati. Lorem ipsum dolor, sit amet
              consectetur adipisicing elit. Beatae accusamus eius dignissimos
              odio numquam similique, dolorum consequuntur! Corrupti, voluptas
              iure. Veritatis quod facere, at ducimus quia harum quis maiores
              molestias?
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo
              aliquam sed nam numquam sunt architecto veritatis nobis, aliquid
              similique necessitatibus pariatur, itaque eveniet labore vero.
              Expedita magnam vitae est quae.
            </p>
            <MainButton>
              <span>Read More</span>
            </MainButton>
